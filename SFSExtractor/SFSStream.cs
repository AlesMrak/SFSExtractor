namespace Editor.SFS
{
    ...
    public class SFSStream : Stream, IDisposable
    {
        private int _fd = -1;
        ...
        [DllImport(@"..\rts.dll", EntryPoint="CS_SFSInputStream_Open", CharSet=CharSet.Ansi)]
        private static extern int Open(string name);
